...
מתאים לסלאבים בגודל PSA (כ-84x138 מ"מ). ואגב — אנחנו לא רק מוכרים בַּמְפֶּרים, אנחנו מוכרים גם את הסלאבים עצמם. קניתם קלף גרייד אצלנו? תוסיפו הגנה על זה בפחות מ-$5.

צבע אחיד ב-$4.99, גרסת גליטר (אומברה נוצצת) ב-$5.99 — לסמן ולעצב את האוסף לפי סט, טייפ או פשוט לפי מה שיפה לעין. קונים 3 ומעלה → 15% הנחה אוטומטית בקופה.
