...
**פריים 2 (פרטים):**
"מתאים ל-PSA | ₪15-19 | 3+ = 15% הנחה אוטומטית"
...
- [x] No unverified price/scarcity claims — ₪15-19 range (verified live in Shopify 26.08, after the ILS switch) and "3+ = 15% הנחה" match brief UPDATE 2; "25 יחידות בלבד" matches confirmed total inventory (15 solid + 10 glitter); PSA-only, no CGC/BGS claim.
