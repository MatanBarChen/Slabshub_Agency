...
- [x] No unverified price/scarcity claims — ₪19-22 range (verified live in Shopify 26.08) and "3+ = 15% הנחה" match brief UPDATE 2; "25 יחידות בלבד" matches confirmed total inventory (15 solid + 10 glitter); PSA-only, no CGC/BGS claim.
